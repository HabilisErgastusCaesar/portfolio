    ...
    <main>
      <div className="portfolio-layout">
        ...
        <section>
          ...
          <Navigation.CityLink link={"game"} userId={"logged-out"}>
        ...
        <div>
          ...
          <Navigation.AppLearningLink mkDir={"Learning"} User={"logged-out"}>
            <button>Learning app</button>
